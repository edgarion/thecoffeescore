...
def generate_catalog():
    ...
    acc_base = [
        ...
        ("Fellow Stagg EKG Hervidor Cuello de Cisne", "Fellow", "Hervidores", 169, 189, 9.3, 4.8, "Mejor hervidor pour-over", "Cuello de cisne balanceado, control de temperatura grado a grado y pantalla LCD discreta.", "/assets/products/fellow-stagg.png"),
        ("Fellow Stagg EKG Pro Studio", "Fellow", "Hervidores", 229, 249, 9.7, 5.0, "Pantalla a color y WiFi", "Edición Pro con actualizaciones de firmware WiFi, modo guía y pantalla a color.", "/assets/products/fellow-stagg.png"),
        ("Fellow Carter Move Mug 355ml", "Fellow", "Botellas y termos", 35, 40, 9.2, 4.8, "Revestimiento cerámico", "Taza térmica de viaje con interior cerámico que no altera el sabor del café.", "/assets/products/fellow-carter.png"),
        ("Fellow Atmos Recipiente de Vacío 0.7L", "Fellow", "Almacenamiento", 38, 45, 9.1, 4.7, "Vacío integrado", "Bomba integrada en la tapa que extrae el oxígeno para preservar el café en grano.", "/assets/products/fellow-carter.png"),
        ("Normcore V4 Tamper Dinamométrico 58.5mm", "Normcore", "Herramientas de barista", 49, 59, 9.2, 4.7, "Prensado perfecto", "Guía de nivelación autonivelante y resortes intercambiables de 15lb, 25lb y 30lb.", "/assets/products/normcore-tamper.png"),
        ("Normcore WDT Distribuidor Agujas 0.35mm", "Normcore", "Herramientas de barista", 24, 29, 9.5, 4.9, "Anticanalización", "Deshace los grumos de molienda y homogeneiza la densidad del café en el portafiltro.", "/assets/products/wdt-tool.png"),
        ("Normcore Puck Screen 58.5mm", "Normcore", "Herramientas de barista", 16, 20, 9.3, 4.8, "Ducha limpia", "Malla metálica de 150 micras que reparte el agua uniformemente y mantiene limpio el grupo.", "/assets/products/wdt-tool.png"),
        ("Timemore Black Mirror Basic 2", "Timemore", "Básculas y medición", 55, 65, 9.3, 4.8, "Báscula con temporizador", "Precisión de 0.1g, caudalímetro en tiempo real (flow-rate) y batería recargable USB-C.", "/assets/products/timemore-scale.png"),
        ("Timemore Black Mirror Nano", "Timemore", "Básculas y medición", 69, 79, 9.5, 4.9, "Ultracompacta espresso", "Dimensiones de 10x10 cm perfecta para bandejas de goteo de máquinas compactas.", "/assets/products/timemore-scale.png"),
        ("Acaia Lunar Báscula de Espresso", "Acaia", "Básculas y medición", 260, 280, 9.8, 5.0, "Estándar del Campeonato Mundial", "Construcción en aluminio resistente al agua con auto-tara, auto-timer y conectividad Bluetooth.", "/assets/products/acaia-lunar.png"),
        ("Acaia Pearl Báscula de Filtro", "Acaia", "Básculas y medición", 160, 180, 9.6, 4.9, "Para Pour-Over", "Tiempo de respuesta en milisegundos con indicador visual de caudal en tiempo real.", "/assets/products/acaia-lunar.png"),
        ("Hario V60 Cerámica 02 Blanca", "Hario", "Cafeteras manuales", 22, 26, 9.2, 4.8, "Icono del café de filtro", "Espiral interior de 60 grados para máxima extracción aromática.", "/assets/products/hario-v60.png"),
        ("Hario Switch Dripper Inmersión 02", "Hario", "Cafeteras manuales", 39, 45, 9.6, 4.9, "Inmersión y goteo", "Válvula de acero y bola que permite combinar inmersión total y vertido libre.", "/assets/products/hario-v60.png"),
        ("Hario Mizudashi Botella Cold Brew 1L", "Hario", "Botellas y termos", 19, 24, 9.1, 4.7, "Infusión en frío", "Filtro permanente integrado para extraer café suave y dulce en nevera durante 12-24h.", "/assets/products/hario-v60.png"),
        ("Chemex 6 Tazas con Collarín de Madera", "Chemex", "Cafeteras manuales", 49, 55, 9.0, 4.7, "Diseño en el MoMA", "Vidrio borosilicato soplado y filtros gruesos que ofrecen la taza más limpia.", "/assets/products/chemex.png"),
        ("Moccamaster KBGT Batch Brew", "Moccamaster", "Cafeteras de filtro", 249, 279, 9.4, 4.9, "Rey del Batch Brew", "Cafetera de filtro por lotes hecha a mano en Holanda con jarra térmica de acero.", "/assets/products/moccamaster.png"),
        ("Motta Jarra Europa Latte Art 500ml", "Motta", "Herramientas de barista", 28, 34, 9.3, 4.8, "Pico vertedor italiano", "Acero inoxidable 18/10 con pico pronunciado ideal para cisnes y rosettas.", "/assets/products/motta-pitcher.png"),
    ]
