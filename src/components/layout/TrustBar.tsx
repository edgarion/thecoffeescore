  ...
  return (
    <div className="brands">
      <div className="brands-inner">
        ...
        {/* Sage */}
        <div className="flex items-center gap-1.5 opacity-85 hover:opacity-100 transition-opacity cursor-default">
          <svg className="h-5 w-auto" viewBox="0 0 110 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* LELIT */}
        <div className="flex items-center gap-1.5 opacity-85 hover:opacity-100 transition-opacity cursor-default">
          <svg className="h-5 w-auto" viewBox="0 0 120 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* De'Longhi */}
        <div className="flex items-center gap-1.5 opacity-85 hover:opacity-100 transition-opacity cursor-default">
          <svg className="h-5 w-auto" viewBox="0 0 150 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Breville */}
        <div className="flex items-center gap-1.5 opacity-85 hover:opacity-100 transition-opacity cursor-default">
          <svg className="h-5 w-auto" viewBox="0 0 125 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* MAZZER */}
        <div className="flex items-center gap-1.5 opacity-85 hover:opacity-100 transition-opacity cursor-default">
          <svg className="h-5 w-auto" viewBox="0 0 135 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* FELLOW */}
        <div className="flex items-center gap-1.5 opacity-85 hover:opacity-100 transition-opacity cursor-default">
          <svg className="h-5 w-auto" viewBox="0 0 130 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* COMANDANTE */}
        <div className="flex items-center gap-1.5 opacity-85 hover:opacity-100 transition-opacity cursor-default">
          <svg className="h-5 w-auto" viewBox="0 0 170 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* LA MARZOCCO */}
        <div className="flex items-center gap-1.5 opacity-85 hover:opacity-100 transition-opacity cursor-default">
          <svg className="h-5 w-auto" viewBox="0 0 160 32" fill="none" xmlns="http://www.w3.org/2000/svg">
